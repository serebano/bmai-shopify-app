<!--
  ...
  (NOT the devtools privacy policy). Published at https://store.busymate.ai/legal/privacy (the listing privacy URL;
  render with `node scripts/render-legal.mjs`). Have counsel review. Last updated: 2026-09.
-->
